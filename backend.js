...
app.get("/NEW", async (req, res) => {
  console.log(req.query.array)
    var file = await fetch("https://cap11-data-default-rtdb.europe-west1.firebasedatabase.app/v/vote.json")
      ...
      console.log(a)
      ver x = await fetch("https://cap11-data-default-rtdb.europe-west1.firebasedatabase.app/v/vote.json",{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)})
